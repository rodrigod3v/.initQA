export const httpRequestStyles = {
    ...
    header: "h-auto lg:h-16 border-b border-main flex flex-col lg:flex-row items-start lg:items-center justify-between px-4 py-2 lg:py-0 bg-surface/30 shrink-0 gap-2 lg:gap-0",
    headerBrandContainer: "flex items-center gap-3 shrink-0 w-full lg:w-auto justify-between lg:justify-start",
    ...
    headerActions: "flex-1 flex items-center justify-end gap-3 lg:ml-6 w-full lg:w-auto",

    main: "flex-1 flex flex-col lg:flex-row overflow-hidden gap-2 p-2",

    // Three-Column Layout Proportions
    sidebar: "w-full lg:w-[240px] border border-main bg-surface/10 flex flex-col shrink-0 overflow-hidden h-[200px] lg:h-auto",
    ...
    editorContainer: "flex-1 flex flex-col min-w-0 gap-2 overflow-hidden min-h-[400px] lg:min-h-0",
    ...
    urlInput: "flex-1 bg-deep border border-sharp border-main px-3 text-[11px] text-primary-text font-mono focus:border-accent/50 focus:outline-none placeholder:text-secondary-text/30 h-8",
    ...
    resultsPanel: "w-full lg:w-[400px] bg-surface/5 border border-main flex flex-col shrink-0 overflow-hidden relative h-[300px] lg:h-auto",
